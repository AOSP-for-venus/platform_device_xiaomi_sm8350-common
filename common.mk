...
# Dolby Vision
$(call soong_config_set_bool,dolby_vision,enabled,true)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.xiaomi_sm8350.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.xiaomi_sm8350.rc
...
# Sensors
$(call soong_config_set_bool,SENSORS_XIAOMI,USES_SINGLE_TAP_SENSOR,true)
